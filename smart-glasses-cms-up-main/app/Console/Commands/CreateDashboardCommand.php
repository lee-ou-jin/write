...
class CreateDashboardCommand extends Command
{
    ...
    protected $name = "amuz-cms:dashboard";
    ...
    public function handle()
    {
        ...
        $this->createDirIfDoesntExists('src/Nova/Dashboards', $this->studly($package));

        $file = $this->dir($this->studly($package))."/src/Nova/Dashboards/{$this->studly($dashboard)}.php";
