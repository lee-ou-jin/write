...
class CreateActionCommand extends Command
{
    ...
    protected $name = "amuz-cms:action";
    ...
    public function handle()
    {
        ...
        $this->createDirIfDoesntExists('src/Nova/Actions', $this->studly($package));

        file_put_contents($this->dir($this->studly($package))."/src/Nova/Actions/{$this->studly($action)}.php", $template);
